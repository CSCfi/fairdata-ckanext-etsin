...
if __name__ == '__main__':
    ...
    dataset = helpers._get_json_as_dict('metax_json_dicts/minimum_valid_edited.json')
    dataset['identifier'] += helpers._create_identifier_ending()
    print "Posting dataset {} with identifier {}".format(filename, dataset['identifier'])
